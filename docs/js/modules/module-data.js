// /docs/js/modules/module-data.js
// Define homepage modules in structured format

window.modules = [
  {
    title: "🧠 Learn Encryption (CPU)",
    desc: "Explore cryptographic concepts and how encryption protects your data.",
    path: "modules/cpu/cpu.html",
    button: "Open CPU"
  },
  {
    title: "🧨 Cryptographic Failures (SEC)",
